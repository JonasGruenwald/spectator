...
pub fn list_items(pantry: Subject(Message)) -> Set(String) {
  actor.call(pantry, ListItems(_), timeout)
}
...
pub type Message {
  ...
  ListItems(reply_with: Subject(Set(String)))
  Shutdown
}
